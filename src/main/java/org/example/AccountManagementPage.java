...
public class AccountManagementPage extends Application {
    ...
    private void createButtonLayout(VBox centerContainer) {
        Button createEmployeeButton = ButtonStyle.expandPaneStyledButton("Create Employee Account");
        Label createEmployeeDescription = new Label("");
        createEmployeeDescription.setTextFill(Color.WHITE);
        createEmployeeButton.setOnAction(event -> createEmployeePage());

        Button editManagersButton = ButtonStyle.expandPaneStyledButton("Edit Employee Account");
        Label editManagersDescription = new Label("");
        editManagersDescription.setTextFill(Color.WHITE);
        editManagersButton.setOnAction(event -> openEditManagerDialog());

        Button editUsersButton = ButtonStyle.expandPaneStyledButton("Edit Clients Account");
        Label editUsersDescription = new Label("");
        editUsersDescription.setTextFill(Color.WHITE);
        editUsersButton.setOnAction(event -> openEditClientDialog());

        Button deleteButton = ButtonStyle.expandPaneStyledButton("Delete Clients Account");
        Label deleteDescription = new Label("");
        ...
        Label blockDescription = new Label("");
        blockDescription.setTextFill(Color.WHITE);
        blockButton.setOnAction(event -> blockWindow.showBlockDialog());

        Button changeKeysButton = ButtonStyle.expandPaneStyledButton("Change Bonus Keys");
        Label changeKeysDescription = new Label("");
        ...
        centerContainer.getChildren().addAll(
                createEmployeeButton, createEmployeeDescription,
