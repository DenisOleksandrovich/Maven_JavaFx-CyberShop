...
public class SessionManager {
    ...
    public boolean isAuthenticated() {
        return clientEnter || managerEnter;
    }

    public String getIpAddress() {
        String ipAddress = "1.0.0.1";
        try {
    ...
    public String getCountryByIp(String ipAddress) {
        ...
        try {
            URI uri = new URI("http://ip-api.com/json/" + ipAddress);
            URL url = uri.toURL(); // Используем URI для создания URL
