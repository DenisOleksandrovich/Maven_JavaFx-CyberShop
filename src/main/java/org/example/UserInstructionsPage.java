...
public class UserInstructionsPage extends Application {
    ...
    private class HeaderComponent {
        ...
        private VBox createHeader() {
            ...
            HBox topContent = new HBox(5);
            topContent.getChildren().addAll(logoCircle, menuButton, supportButton, privacyButton, accountButton);
