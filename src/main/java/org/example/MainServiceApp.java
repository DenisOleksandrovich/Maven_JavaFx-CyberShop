...
public class MainServiceApp extends Application {
    ...
    private class MainPage {
        ...
        private VBox createWidgetsSection(Stage primaryStage) {
            ...
            DoubleBinding paddingPercent = primaryStage.widthProperty().multiply(0.1);
            currentImage.fitWidthProperty().bind(primaryStage.widthProperty().subtract(paddingPercent));
            currentImage.fitHeightProperty().bind(currentImage.fitWidthProperty().multiply(9.0 / 16.0));
        ...
        private Circle createPartnerImage(Partner partner) {
            ...
            partnerImage.setOnMouseClicked(event -> OpenWeb.openLink(partner.getWebsite()));
